...
# isko comment kiya hai ek din ke liye ke agar usse shai resulty aya toh yeh comment rehega
# jiske code fast ho jaye 
...
#  yaha tak hai wo code necche nayaa code 
